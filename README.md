...
- Kaggle Notebook: https://www.kaggle.com/code/alexandermeau/popular-songs-analysis
...
- **Explore popular songs data** (e.g., from Spotify or other sources)
- **Visualize distributions and correlations** among audio features
- **Analyze trends** in song attributes over years and genres
- Potentially **apply machine learning models** to predict popularity or related targets
- Draw insights about the **characteristics of hit songs**
